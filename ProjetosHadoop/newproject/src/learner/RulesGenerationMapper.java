...
/**
 * Mapper class that generates a single rule for each instance
 * @author Mikel Elkano Ilintxeta
 * @version 1.0
 */
public class RulesGenerationMapper extends Mapper<Text, Text, ByteArrayWritable, ConsequentPart>{
